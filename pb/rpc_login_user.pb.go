...
func (x *LoginUserResponse) GetAccessTokenExpiredAt() *timestamppb.Timestamp {
	if x != nil {
...
func (x *LoginUserResponse) GetRefreshTokenExpiredAt() *timestamppb.Timestamp {
	if x != nil {
...
const file_rpc_login_user_proto_rawDesc = "" +
	...
	"\x17access_token_expired_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x14accessTokenExpiredAt\x12S\n" +
	"\x18refresh_token_expired_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x15refreshTokenExpiredAt\x12\x1c\n" +
	"\x04user\x18\x06 \x01(\v2\b.pb.UserR\x04userB&Z$github.com/dorasaicu12/simplebank/pbb\x06proto3"
...
var file_rpc_login_user_proto_depIdxs = []int32{
	2, // 0: pb.LoginUserResponse.access_token_expired_at:type_name -> google.protobuf.Timestamp
	2, // 1: pb.LoginUserResponse.refresh_token_expired_at:type_name -> google.protobuf.Timestamp
